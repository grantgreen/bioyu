...
//isAdmin
UserProvider.prototype.isAdmin = function(username, callback) {
    this.getCollection(function(error, user_collection) {
      if( error ) return false;
      else {          
        user_collection.findOne({'username': username, 'isadmin': true}, function(error, result) {
          if( error ) callback(error, null);
          else if (result != null ) callback(null, true);
