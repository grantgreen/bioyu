...
MongoClient.connect('mongodb://127.0.0.1:27017/yubio_c', function(err, db) {
    if(err) throw err;
	...
	*/
	...
	// Months
	var expires = new Date(d.getFullYear(), d.getMonth()+1, 0, 25, 59, 59).getTime();
...
//		    result.name = "Ultimate Choice";
		    var msg = encodeURIComponent("Yubio konkurrencen november 2016:\n" + result.name + ".\n Klik på linket nedenfor, for at starte");
		    facebookProvider.getPageAccessToken(function(error, token) {
