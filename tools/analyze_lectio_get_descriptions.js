...
//	https://www.lectio.dk/lectio/645/default.aspx
//    var myRe = /lectio\/(\d+)\/.*lecafdeling=(\d+)'>(.*)<\/a/g;
    var myRe = /lectio\/(\d+)\/default.aspx'>(.*)<\/a/g;
    var myArray;
    var resultArray = [];
...
//    console.log('https://www.lectio.dk/lectio/' + schoolInfo.schoolId + '/studieplan/hold_undervisningsbeskrivelse.aspx?holdelementid=' + classId);
	...
	writeToFile("tools/undervisningsbeskrivelser/2016", "skole_" + schoolInfo.schoolId + "-hold_" + classId, body);
