...
var getChapterList = function(topic) {
	...
	for(var i = 0; i < chapterList.length; i++) {		    
	    ...
	    var contentButton = textButton("buttonContainer", 'animations.html?chapter=' + (i+1), '<br />' + chapterList[i].replace(': ', '<br />').replace('Kapitel', ''), color, "90X140");
	}
...
var initializePage = function(chapter, topic) {
    ...
    var mainTopic = imgButton("mainTopic", "animations_selector.html", 'images/icons/yubio_video_icon.svg');
